  ...
  return(
     ...
     <div className='w-full max-w-md mx-auto shadow-md rounded-lg px-4 my-4 text-red-500 bg-gray-500'>
      <div className='flex shadow rounded-lg overflow-hidden mb-4'>
        ...
        <button className='outline-none bg-blue-800 text-white px-4 py-2 shrink-5 hover:cursor-pointer hover:text-blue-300'onClick={copyPasswordToClipboard}>copy<IoCopy />
</button>
      </div>
